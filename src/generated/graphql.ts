...
export function getSdk(
  ...
  return {
    ...
    createCalloutOnCalloutsSet(
      variables: CreateCalloutOnCalloutsSetMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<{
      data: CreateCalloutOnCalloutsSetMutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.rawRequest<CreateCalloutOnCalloutsSetMutation>(
    ...
    accountAdminsInfo(
      variables?: AccountAdminsInfoQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<{
      data: AccountAdminsInfoQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.rawRequest<AccountAdminsInfoQuery>(
    ...
    spacesAboutInfo(
      variables?: SpacesAboutInfoQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<{
      data: SpacesAboutInfoQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.rawRequest<SpacesAboutInfoQuery>(
    ...
    adminUpdateContributorAvatars(
      variables: AdminUpdateContributorAvatarsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<{
      data: AdminUpdateContributorAvatarsMutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.rawRequest<AdminUpdateContributorAvatarsMutation>(
